...
const ApplyJob = () => {
  ...
  const { jobs,backenUrl,userData, userApplications,fetchUserApplications} = useContext(AppContext)
          ...
          <div className='bg-white text-black rounded-lg w-full'>
            <div className='flex justify-center md:justify-between flex-wrap gap-8 px-14 py-20 mb-6 bg-sky-50 border border-sky-400 rounded-xl'>
              <div className='flex flex-col md:flex-row items-center'>
                <img className='h-24 bg-white rounded-lg p-4 mr-4 max-md:mb-4 border'
                  src={JobData.companyId.image} alt="Company Logo" />
            ...
            <div className='flex flex-col lg:flex-row justify-between items-start'>
              ...
              <div className='w-full lg:w-1/3 mt-8 lg:mt-0 lg:ml-0 space-y-5'>
                <h2>More Jobs From Company {JobData.companyId.name}</h2>
                {
                  jobs.filter(
