...
if(data.success){
  ...
  return jobs ? jobs.length === 0?(<div className='flex items-center justify-center h-[70vh]'>
    <p className='text-xl sm:text-2xl'>No Jobs Avaailable or Posted</p>
  </div>): (
...
<tr key={index} className='text-gray-700'>
  ...
  <input onChange={()=>changeJobVisiblity(job._id)} className='ml-4 scale-125' type="checkbox" checked={job.visible}  />
  </td>
</tr>
